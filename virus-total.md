...
После проверок программами нужно проверить, не остались ли подозрительные файлы. В поисках поможет [список](https://www.virustotal.com/#/domain/lesnyeozera.com) найденных вредоносов 
